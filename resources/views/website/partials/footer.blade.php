    ...
    <div class="container ">
      <div class="main row " style="display:flex ; align-items: flex-start;">
        ...
        <div class="alinks col-md-3">
          ...
          <ul class="list">
            <li class="items"><a href="#">link for serves</a></li>
            <li class="items"><a href="#">link for about </a></li>
            <li class="items"><a href="#">link for blogs</a></li>
            <li class="items"><a href="#">link for home</a></li>
            <li class="items"><a href="#">link for loremipsum</a></li>
          </ul>
        </div>
